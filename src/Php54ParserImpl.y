...
array_method_dereference:
		array_method_dereference '[' dim_offset ']'				{ $$ = observers.ExpressionMakeNil();}
	|	method '[' dim_offset ']'								{ $$ = observers.ExpressionMakeNil(); }
;

method:
		'(' function_call_parameter_list ')'					{ $$ = observers.ExpressionMakeNil(); } 
;
